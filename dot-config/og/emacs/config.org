...
(use-package ws-butler
  :straight (ws-butler :type git :host github :repo "ws-butler")
  :custom
...
(use-package cobol-superbol-mode
  :defer t
  :mode (("\\.cob\\'" . cobol-superbol-mode)
         ("\\.cbl\\'" . cobol-superbol-mode)
         ("\\.cpy\\'" . cobol-superbol-mode))
  :vc (cobol-superbol-mode :url "https://github.com/OCamlPro/superbol-studio-oss/"
                           :lisp-dir "emacs/"
                           :rev :newest)
  :custom
  (cobol-tab-width 3))
...
(use-package consult-project-extra
  ;; :straight t
  :bind (("C-x p o" . consult-project-extra-find)))
#+end_src
** corfu
#+begin_src emacs-lisp
(use-package corfu
...
(use-package vertico
  ...
  (setq vertico-count 16) ;; Show more candidates
  (setq vertico-resize t) ;; Grow and shrink the Vertico minibuffer
  (setq vertico-cycle nil)
  (setq vertico-multiform-commands '((find-file (vertico-sort-function . vertico-sort-alpha)))))
#+end_src
** embark
#+begin_src emacs-lisp
(use-package embark
...
(with-eval-after-load 'eglot
  ...
  (let* ((query-driver (if (eq window-system 'w32)
                           "--query-driver=*:\\**\\*"
                         "--query-driver=/**/*")))
