...
(use-package undo-fu
  ...
  (setq undo-outer-limit (* 96 1024 1024)) ; 96mb.
  :config
...
(use-package consult
  ...
  :bind (;; M-s bindings in `search-map'
         (:prefix-map consult-search-prefix-map :prefix "C-c s")
  ...
  :bind (;; M-g bindings in `goto-map'
         (:prefix-map consult-goto-prefix-map :prefix "C-c g")
